$(function() {
	...
	//CALLBACK//
	//2022-06-05 отключаем форму обратной связи
	...
	$(".show-email").click(function() {
		var clickitem = $(this);
		var isSetActive = clickitem.hasClass('active');

		$('.top_panel .panel-control .active').removeClass('active');
		$('header .header-control').slideUp();
		$('.top_panel .panel-control .submenu').slideUp();
...
//CATALOG_MENU_HIDDEN//
	...
	var phoneInputs = [
		$(document).find('input[name=UF_TEL]'),
		$(document).find('input[name=PHONE]')
	];
