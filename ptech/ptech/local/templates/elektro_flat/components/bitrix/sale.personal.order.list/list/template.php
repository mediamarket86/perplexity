						...
						<div class="tr">
							<div class="tr_into">
								...
								<div class="cart-items basket <?=$accountHashNumber?>" style="display:none;">
                                    <div class="cart-items-header"><?=GetMessage("STPOL_ORDER_HEADER")?></div>
									<div class="equipment-order basket">
										<div class="thead">
                                            <div class="cart-item-number"><?=GetMessage("STPOL_ORDER_NUMBER")?></div>
                                            <div class="cart-item-vendor-code"><?=GetMessage("STPOL_ORDER_VENDOR_CODE")?></div>
                                            <div class="cart-item-image"><?=GetMessage("STPOL_ORDER_PHOTO")?></div>
											...
											foreach($val["BASKET_ITEMS"] as $arBasketItems) {?>
												<div class="tr">
													<div class="tr_into">
                                                        ...
                                                        <div class="cart-item-vendor-code"><?=$arBasketItems['CML2_ARTICLE']?></div>
														...
														<div class="cart-item-name">
															...
															<?}?>
                                                           <?php /*
                                                                    //2022-11-08 ВЫВОД СВОЙСТ КОРЗИНЫ в списке заказа, пока скрыто, через 6 мес. удалить
...
<!--											--><?//}?>
								...
								<div class="order-item-actions <?=$accountHashNumber?>" style="display:none;">
									<div class="left btn-wrap">
                                        ...
                                        <a class="btn_buy apuo favorites-btn" href="/favorites/?addFormOrder=<?=$val['ORDER']['ID']?>" title="<?=GetMessage('STPOL_ORDER_TO_FAVORITES_BTN_PART_1')?> <?=GetMessage('STPOL_ORDER_TO_FAVORITES_BTN_PART_2')?>">
                                            <span class="text"><?=GetMessage('STPOL_ORDER_TO_FAVORITES_BTN_PART_1')?></span>
                                            <span class="text"><?=GetMessage('STPOL_ORDER_TO_FAVORITES_BTN_PART_2')?></span>
                                        </a>
