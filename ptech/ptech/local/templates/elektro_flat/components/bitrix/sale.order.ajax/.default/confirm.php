...
if(!empty($arResult["ORDER"])) {?>
    ...
    <div class="order-confirm actions">
        ...
        <div class="export-order">
            ...
            <?php /** костыль для добавления кнопки в избранное в заголовок */?>
            <script>
                BX.ready(function () {
                    let html = '<a class="btn_buy apuo favorites-btn" href="/favorites/?addFormOrder=<?=$arResult["ORDER"]["ID"]?>" title="Добавить заказ в избранное"><span class="text">Добавить заказ в избранное</span></a>';
                    let elm = document.createElement('span');
                    $(elm).addClass('order-confirm');
                    $(elm).html(html).appendTo('#pagetitle');
                });
            </script>
        </div>
    </div>
