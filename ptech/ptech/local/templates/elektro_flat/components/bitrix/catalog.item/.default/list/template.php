			...
			<?} else {?>											
				<span class="catalog-item-price">
					...
					<?if($arSetting["REFERENCE_PRICE"] == "Y" && !empty($arSetting["REFERENCE_PRICE_COEF"])) {?>
						<span class="catalog-item-price-reference">
							<?=number_format($arElement["MIN_PRICE"]["RATIO_PRICE"] * $arSetting["REFERENCE_PRICE_COEF"], $arCurFormat["REFERENCE_DECIMALS"], $arCurFormat["DEC_POINT"], $arCurFormat["THOUSANDS_SEP"]);?>
							<span><?=$currency?></span>
						</span>
					<?}?>
				</span>											
