...
if (isset($arResult['MODIFIED_PARAMS']['SLIDER_ASPECT_RATIO']) && 'DEFAULT' == $arResult['MODIFIED_PARAMS']['SLIDER_ASPECT_RATIO']) {
    $coeff = 0.5;
} else {
	...
	<script type="text/javascript">		
		$(function() {
			$(".anythingSlider").anythingSlider({
			    "appendForwardTo":  ".anythingContainer .custom-slider-controls .button.forward",
			    "appendBackTo": ".anythingContainer .custom-slider-controls .button.back",
				"expand": true,
				"delay": '.$delay.',
