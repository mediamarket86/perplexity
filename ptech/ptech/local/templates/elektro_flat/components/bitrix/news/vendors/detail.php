...
if(!empty($arCurVendor["PREVIEW_TEXT"])) {
	if(!$_REQUEST["PAGEN_1"] || empty($_REQUEST["PAGEN_1"]) || $_REQUEST["PAGEN_1"] <= 1) {?>
        <?php if (! empty($arCurVendor['PREVIEW_PICTURE']['SRC'])): ?>
            <div class="vendor-logo">
                <img class="vendor-logo__img" src="<?=$arCurVendor['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arCurVendor['NAME']?>" title="<?=$arCurVendor['NAME']?>">
            </div>
        <?php endif?>
