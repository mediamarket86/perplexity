...
foreach($arResult["SECTIONS"] as $key => $arSection):
    if (isset($arSection['UF_SECTION_ICON']) && (int)$arSection['UF_SECTION_ICON']) {
        $arResult["SECTIONS"][$key]['UF_SECTION_ICON'] = CFile::GetFileArray((int)$arSection['UF_SECTION_ICON']);
    }
