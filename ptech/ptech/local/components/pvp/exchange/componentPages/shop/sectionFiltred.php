...
<?php $APPLICATION->IncludeComponent("bitrix:catalog.section", "",
    array(
        ...
        "PAGE_ELEMENT_COUNT" => ($arResult['PAGE_ELEMENT_COUNT']) ?? $exchangeComponent->getCatalogParam("PAGE_ELEMENT_COUNT"),
        ...
        "OFFERS_LIMIT" => ($arResult['LIST_OFFERS_LIMIT']) ?? $exchangeComponent->getCatalogParam("LIST_OFFERS_LIMIT"),
