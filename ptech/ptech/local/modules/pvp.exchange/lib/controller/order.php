...
class Order implements ControllerInterface
{
    ...
    public function create()
    {
		...
		//Свойства заказа MOBIL_APP
		$propertyCollection = $order->getPropertyCollection(); //Получаем объект propertyCollection
		$property = $propertyCollection->getItemByOrderPropertyId('99'); //Получаем объект свойства с ID = $prop_id
		$property->setValue("Y"); //Устанавливаем значение свойству
