...
class Basket
{
    ...
    public function loadFromExcel($basket){
...
//                'ACTIVE' => 'Y', //Мир еще не готов к синхронизации
    ...
    {
        return Sale\Basket::loadItemsForFUser(Sale\Fuser::getId(false), Context::getCurrent()->getSite());
    }
}