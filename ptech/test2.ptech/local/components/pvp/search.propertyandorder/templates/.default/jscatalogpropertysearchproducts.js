(function (window) {
	...
	if(!!window.JCCatalogPopertySearchProducts) {
		return;
	}	
	...
	window.JCCatalogPopertySearchProducts = function (arParams) {
		this.productType = 0;
	...
	window.JCCatalogPopertySearchProducts.prototype.Init = function() {
	...
	window.JCCatalogPopertySearchProducts.prototype.QuantityUp = function() {
		var curValue = 0,
			boolSet = true;
...
window.JCCatalogPopertySearchProducts.prototype.QuantityDown = function() {
		var curValue = 0,
			boolSet = true;
	...
	window.JCCatalogPopertySearchProducts.prototype.QuantityChange = function() {
		var curValue = 0,
			intCount,
			count;
	...
	window.JCCatalogPopertySearchProducts.prototype.OpenPriceRangesPopup = function() {
	...
	window.JCCatalogPopertySearchProducts.prototype.OpenPriceMatrixPopup = function() {
		var target = BX.proxy_context,
	...
	window.JCCatalogPopertySearchProducts.prototype.OpenPropsPopup = function() {
	...
	window.JCCatalogPopertySearchProducts.prototype.OpenFormPopupQuickView = function() {
	...
	window.JCCatalogPopertySearchProducts.prototype.OpenFormPopup = function() {
		var target = BX.proxy_context,
			action = target.getAttribute("data-action"),
			visualId = action + "_" + this.visual.ID,
			elementId = this.product.id,
	...
	window.JCCatalogPopertySearchProducts.prototype.Add2Basket = function() {
		var target = BX.proxy_context,
	...
	window.JCCatalogPopertySearchProducts.prototype.BasketResult = function() {
		var close,
			strContent,
			strPictSrc,
			strPictWidth,
	...
	window.JCCatalogPopertySearchProducts.prototype.BasketRedirect = function() {
