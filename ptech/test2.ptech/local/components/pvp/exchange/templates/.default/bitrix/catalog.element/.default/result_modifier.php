...
if ($arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['PRICE'] < $elementMinPrice) {
    $arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['PRINT_RATIO_DISCOUNT'] = CurrencyFormat($arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['BASE_PRICE'] - $elementMinPrice, $arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['CURRENCY']);
    $arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['PRINT_RATIO_PRICE'] = CurrencyFormat($elementMinPrice, $arResult['ITEM_PRICES'][$arResult['ITEM_PRICE_SELECTED']]['CURRENCY']);
}
