...
class CBitrixPersonalOrderListComponent extends CBitrixComponent
{
	...
	protected function formatResult()
	{
        ...
        /**  Кастомный вывод данных постраничной навигации */
        $navData['ITEM_COUNT'] = $this->dbQueryResult['ORDERS']->NavRecordCount;
        $navData['PAGE_COUNT'] = $this->dbQueryResult['ORDERS']->NavPageCount;
        $navData['PAGE_NUMBER'] = $this->dbQueryResult['ORDERS']->NavPageNomer;

        $arResult['NAV'] = $navData;
        /** ----------------------------------------------- */
