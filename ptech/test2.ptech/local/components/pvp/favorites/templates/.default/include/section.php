<?php
global $arrFilter;
$arrFilter['ID'] = $arResult['PRODUCT_IDS'];
?>


<?php if (count($arrFilter['ID'])): ?>
...
<?php else : ?>
    <div class="alertMsg info no-products">
        <?php if (empty($arResult['FILTER_SECTION'])) : ?>
            <?=GetMessage('NO_ADDED_PRODUCT')?>
        <?php else : ?>
            <?=GetMessage('NO_FILTERED_PRODUCT')?>
        <?php endif ?>
    </div>
<?php endif ?>
