...
if ($haveOffers) {
    if (is_array($arElement["TOTAL_OFFERS"]["PRICE_MATRIX_SHOW"]["COLS"]) && count($arElement["TOTAL_OFFERS"]["PRICE_MATRIX_SHOW"]["COLS"]) > 1 && empty($arElement["CURRENT_DISCOUNT"]["ACTIVE_TO"])) {
        $class = " item-pm";
    }
}
