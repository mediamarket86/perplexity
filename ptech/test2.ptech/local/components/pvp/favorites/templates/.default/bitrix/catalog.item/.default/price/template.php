...
<div class="catalog-item-info">
    <div class="mass-action controls">
        <label class="controls__label active" for="mass-action-controls-item-<?=$itemIds['ID']?>"></label>
        <input class="controls__checkbox" id="mass-action-controls-item-<?=$itemIds['ID']?>" type="checkbox" checked data-bx-item-id="<?=$itemIds['ID']?>">
    </div>
	...
	<div class="catalog-item-title<?=$class?>">
		<a class="catalog-item-title__link" href="<?=$arElement['DETAIL_PAGE_URL']?>" title="<?=$arElement['NAME']?>" itemprop="url">
