...
//CATALOG_DETAIL//?>
<div id="<?=$arItemIDs['ID']?>" class="catalog-detail-element not-auth-view" itemscope itemtype="http://schema.org/Product">
			...
			<div class="catalog-detail">
				...
				<div class="column three<?=($arResult["COLLECTION"]["THIS"]) ? " colletion" : ""?>">
					<div class="price_buy_detail">
                        <div class="catalog-detail-item-no-price">
							Необходимо пройти регистрацию, что бы увидеть цену за 1 шт.
                        </div>
                        ...
                        <div class="need-register-block">
                            <a class="register-btn" href="<?=REGISTER_INFO_LINK?>">Зарегистрироваться</a>
                        </div>
        			</div>
				</div>
			</div><br>
