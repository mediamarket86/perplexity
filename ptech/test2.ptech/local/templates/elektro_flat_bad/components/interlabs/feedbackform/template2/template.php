    ...
    <div class="interlabs-feedbackform__container__dialog">
        ...
        <div class="body">
            ...
            <form method="post" enctype="multipart/form-data" action=""
                  ...
                  class="<?php echo $arResult['AJAX_MODE'] === 'Y' ? ' ' : ''; ?>">
                <?php if ($arResult['AJAX_MODE'] === 'Y') {//only for json response  ?>
                        ...
                        switch ($field['TYPE']) {
                            case 'file[]':
                                ...
                                <label class="file">
									...
									<a onclick="document.getElementById('<?php echo $idFileField; ?>').click();return false;">Прикрепить файл.</a>
                            ...
                            default:
                                ...
                                <input id="<?php echo $code; ?>" name="<?php echo $code; ?>"
                                       ...
                                       type="<?if ($code=='EMAIL'):?>email<?elseif ($code=='PHONE'):?>phone<?else:?>text<?endif;?>"
                ...
                <?php if ($arResult['AGREE_PROCESSING'] === 'Y') { ?>
                    <div class="form-group agree">
                        <div class="c-checkbox">
                            ...
                            <label for="AGREE_PROCESSING"><span
                                        class="agree-text"><?php echo Loc::getMessage("AGREE_PROCESSING"); ?></span><span
                ...
                <div class="form-group button">
					...
					<input type="reset" value="Очистить" class="modal-default-button clear">
