...
$MESS["phone"] = "Телефон";
$MESS["email"] = "email";
$MESS["CAPTCHA_ENTER_CODE"] = "Пройдите капчу";

$MESS["AGREE_PROCESSING"] = 'При отправке данной формы Вы подтверждаете свою дееспособность и согласие на <a href="/about/agreement/" target="_blank">обработку персональных данных.</a>';
...
$MESS["FORM_SAVED"] = "Спасибо, ваше сообщение принято!";
...
$MESS['INPUT_FILE_DEFAULT']='Прикрепить файл';
