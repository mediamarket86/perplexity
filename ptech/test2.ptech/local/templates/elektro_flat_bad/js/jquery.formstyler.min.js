          ...
          var s = function()
          {
            ...
            function b()
            {
              for (var a = 0, c = g.length; a < c; a++)
              {
                ...
                g.eq(a).parent().is("optgroup") && (void 0 !== g.eq(a).parent().attr("class") && (p = " " + g.eq(a).parent().attr("class")), b = "<li" + w + ' class="' + e + d + " option" + p + '">' + g.eq(a).html() + "</li>", g.eq(a).is(":first-child") && (b = '<li class="optgroup' + p + '">' + g.eq(a).parent().attr("label") + "</li>" + b));
                s += b
              }
            }
            function h()
            {
              var d = new A,
                  ...
                  x = a.data("search-not-found"),
                  p = a.data("search-placeholder"),
                  w = a.data("z-index"),
                  u = a.data("smart-positioning");
              void 0 === k && (k = e.selectPlaceholder);
              if (void 0 === y || "" === y) y = e.selectSearch;
              ...
              var E = c("div.jq-selectbox__select", f),
                  t = c("div.jq-selectbox__select-text", f),
                  d = g.filter(":selected");
              b();
              ...
              var q = c("ul", l),
                  m = c("li", l),
                  z = c("input", l),
                  v = c("div.jq-selectbox__not-found", l).hide();
...
//console.log('f=',f);
              ...
              r.remove();
//console.log('do', 't='+t.width(),'l='+l.width(),'f='+f.width());
              k == f.width() && t.width(F);
              //B > f.width() && l.width(B); //из за этого был баг у фильтров сортировки, ширина делалась 22px
//console.log('posle', 't='+t.width(),'l='+l.width());
...
//console.log('t='+t.width());
              ...
              l.hide();
              r.length && (g.first().text() != d.text() && f.addClass("changed"), f.data("jqfs-class", r.data("jqfs-class")), f.addClass(r.data("jqfs-class")));
              ...
              E.click(function()
              {
                ...
                if (!navigator.userAgent.match(/(iPad|iPhone|iPod)/i))
                {
                  var b = c(window),
                      p = m.data("li-height"),
                      d = f.offset().top,
                      r = b.height() - G - (d - b.scrollTop()),
                      k = a.data("visible-options");
                  ...
                  !0 === u || 1 === u ? r > y + C + 20 ? (k(), f.removeClass("dropup").addClass("dropdown")) : (t(), f.removeClass("dropdown").addClass("dropup")) : (!1 === u || 0 === u) && r > y + C + 20 && (k(), f.removeClass("dropup").addClass("dropdown"));
                  c("div.jqselect").css(
                  {
                    zIndex: w - 1
                  }).removeClass("opened");
              ...
              }).on("keydown.styler keyup.styler", function(c)
              {
                ...
                13 == c.which && (c.preventDefault(), l.hide(), f.removeClass("opened dropup dropdown"), e.onSelectClosed.call(f))
              }).on("keydown.styler", function(a)
              {
            ...
            function d()
            {
              ...
              v > d.height() && (k.css("overflowY", "scroll"), n(k), h.filter(".selected").length && k.scrollTop(k.scrollTop() + h.filter(".selected").position().top));
              a.prependTo(d).css(
              {
                position: "absolute",
                left: 0,
              ...
              }), v > d.height()) a.on("keydown.styler", function(a)
              {
                ...
                40 != a.which && 39 != a.which && 34 != a.which || k.scrollTop(k.scrollTop() + h.filter(".selected:last").position().top - k.innerHeight() + 2 * x)
              })
            }
            var g = c("option", a),
                s = "";
            if (a.is("[multiple]"))
            {
              var v = navigator.userAgent.match(/Android/i) ? !0 : !1,
