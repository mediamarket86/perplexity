				...
				if($category_id === "all") {
					...
					<div class="tvr_search">						
						...
						<div class="<?=(!empty($arElement['MIN_PRICE']) || !empty($arElement['TOTAL_OFFERS']['MIN_PRICE']) ? 'item_' : 'cat_');?>title">
							<?//ITEM_ARTICLE//
							if(!empty($arElement["PROPERTIES"]["CML2_ARTICLE"]["VALUE"]) && !$arElement["COLLECTION"]) {?>
								<span class="article"><?=GetMessage("CATALOG_ELEMENT_ARTNUMBER").$arElement["PROPERTIES"]["CML2_ARTICLE"]["VALUE"];?></span>
							<?}
							//ITEM_TITLE//?>
