	...
	<div class="fields">
		...
		<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
			...
			<?if($arParams["NOT_SHOW_LINKS"] != "Y"){?>
                ...
                <div class="field field-button">
                    <a class="btn_buy boc_anch" href="<?=SITE_DIR?>register/" rel="nofollow"><i class="fa fa-user-plus"></i><?=GetMessage("AUTH_REGISTER")?></a>
                </div>
                <div class="field field-button">
					<a class="btn_buy boc_anch" href="<?=SITE_DIR?>register/" rel="nofollow"><i class="fa fa-user-plus"></i><?=GetMessage("AUTH_HELP")?></a>
				</div>				
			<?}?>
		</form>
		<script type="text/javascript">
