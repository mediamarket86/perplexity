...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			this.orderCommentBlockNode = BX('bx-soa-orderComment');
			...
			this.initOptions();
			this.editOrder();
			this.editPropsComment(this.orderCommentBlockNode);
			this.bindEvents();
		...
		sendRequest: function(action, actionData)
		{
			...
			if (action == 'saveOrderAjax')
			{
				...
				var r = BX.ajax.submit(BX('bx-soa-order-form'), BX.proxy(this.saveOrder, this));
			}
			...
			while (group = groupIterator())
			{
				...
				while (property = propsIterator())
				{
					if (this.deliveryLocationInfo.loc == property.getId()
						...
						|| 'ID_PROFILE' == property.getSettings().CODE)
						continue;
