...
/**
 * @var Bitrix\Main\Type\DateTime $activeToObj
 */
$activeToObj = empty($dbItems[0]['ACTIVE_TO']) ? false : $dbItems[0]['ACTIVE_TO'];
if ($activeToObj) {
    $arResult["ACTIVE_TO"] = $activeToObj->format('d.m.Y H:i:s');
}
