...
<a class="personal-user" href="<?=$arParams['PATH_TO_PERSONAL']?>">
	<span class="personal-user__image-wrap">
		<span class="personal-user__image">
            <?if ($arResult['USER']['DISCOUNT']):?>
                <img src="<?= SITE_TEMPLATE_PATH . '/images/user_discount/discount_' . $arResult['USER']['DISCOUNT'] . '.jpg'?>" alt="<?=$strTitle?>" title="<?=$strTitle?>" />
                <?//Ниже какая то шляпа 2022-02-28 ?>
