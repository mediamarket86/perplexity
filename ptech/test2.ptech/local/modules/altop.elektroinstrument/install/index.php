...
class altop_elektroinstrument extends CModule {
	...
	function InstallFiles() {
        $path = $_SERVER["DOCUMENT_ROOT"] . DIRECTORY_SEPARATOR .  "local" . DIRECTORY_SEPARATOR . "components";

		CopyDirFiles(__DIR__."/components/", $path, true, true);
        ...
        rename($path . DIRECTORY_SEPARATOR . self::partnerName . DIRECTORY_SEPARATOR . '.gitignore.tmp',
            $path . DIRECTORY_SEPARATOR . self::partnerName . DIRECTORY_SEPARATOR . '.gitignore');
	...
	function DoInstall(){
		...
		$APPLICATION->IncludeAdminFile(GetMessage("ELEKTROINSTRUMENT_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/".$this->MODULE_ID."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(GetMessage("ELEKTROINSTRUMENT_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/".$this->MODULE_ID."/install/unstep.php");
	}
}?>